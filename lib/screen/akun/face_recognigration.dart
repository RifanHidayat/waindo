...
class FaceRecognition extends StatelessWidget {
  ...
  final list = [
    {
      "icon": "0",
      "title": "Pross absensi lebih cepat",
      "subtitle":
          "Proses absensi dilakukan dengan lebih cepat sehingga dapat menghemat waktu"
    },
    {
      "icon": "1",
      "title": "Mencegah Penyalagunaan absensi",
      "subtitle":
          "memastikan bahwa git hanya orang terdaftar yang dapat melakukan absensi"
    },
  ];
              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(width: 1, color: HexColor('#D5DBE5'))),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "Belum Registrasi",
                                      style:
                                          TextStyle(color: HexColor('#868FA0')),
                                    ),
                                    SizedBox(
                                      height: 10,
                                    ),
