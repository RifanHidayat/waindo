...
//     if (_faceFound) {
//       timer = timer + 1;
//       description = 'Sedang memindai...mohon ditunggu';
//       if (timer == 5) {
//         registration();
//       }
//     } else {
//       timer = 0;
//       description = 'Pastikan wajah kamu tidak tertutup dan terlihat jelas';
//     }
//     return Scaffold(
...
//       print('example foto ${e1}');

//       var dataUser = AppData.informasiUser;
//       var getEmpId = dataUser![0].em_id;
//       controller.faceIdRegistration(faceId: e1, emId: getEmpId);
//     }
//   }
// }
...
class FaceRecognitionView extends StatefulWidget {
  FaceRecognitionView({Key? key}) : super(key: key);
...
class _FaceRecognitionViewState extends State<FaceRecognitionView>
  ...
  Widget build(BuildContext context) {
    ...
    if (_faceFound) {
      timer = timer + 1;
      description =
          'Sedang Registrasi Wajah Kamu..\nSabar ya, sebentar lagi nih..';
      if (timer >= 8) {
        registration();
      }
    } else {
